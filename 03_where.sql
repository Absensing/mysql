...
-- tbl_menu 테이블에서 메뉴 코드, 이름, 판매 상태 를 조회할 건데
...
-- tbl_menu 테이블에서 메뉴코드, 이름, 가격을 조회할건데 가격 10000원 이상 20000원 이하 조회해줘
...
-- 가격이 5000원 넘거나 카테고리 코드가 10인 녀석들을 조회해줘
