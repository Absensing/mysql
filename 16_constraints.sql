...
-- not null 조건과 unique 조건을 합친 것이 primary key라는 것이다.
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
values
(3, 'user03', 'pass03', '홍길동', '남', '010-1234-5678', 'hong123@gmail.com');
...
-- foreign key 제약 조건에 의해 테이블 간의 관계(relationship)가 형성된다.
-- 제공되는 값 외에는 null을 사용할 수 있다.

-- 부모 테이블
drop table if exists uer_grade;
...
insert into user_primary
(user_no, user_id, user_pwd, user_name, gender, phone, email, user_code)
value
(3, 'user03', 'pass03', '유관순1', '여', '010-6789-5678', 'yu123@gmail.com', 10),
